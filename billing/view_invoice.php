...
$invoiceCustomer = invoice_get_customer_info($conn, $invoice);
$patientName = $invoiceCustomer['patient_name'];
    ...
    <div class="invoice-card">
        ...
        <div class="action-buttons">
            ...
            <?php if ($outstandingBalance > 0): ?>
                <a href="/hospital_system/billing/pay_invoice.php?id=<?= $invoiceId ?>" class="btn btn-warning">Record Payment</a>
            <?php endif; ?>
            <?php if ($patientId): ?>
                <a href="/hospital_system/patients/patient_dashboard.php?id=<?= $patientId ?>" class="btn btn-success">Patient Dashboard</a>
            <?php endif; ?>
            <a href="/hospital_system/accounting/ledger.php?invoice_id=<?= $invoiceId ?>" class="btn btn-info">View in Ledger</a>
            <a href="/hospital_system/reports/sales_report.php" class="btn btn-secondary">Sales Reports</a>
            <a href="/hospital_system/billing/view_bills.php" class="btn btn-outline-primary">Back to Bills</a>
        </div>
    </div>
</div>
