...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($amount <= 0) {
        ...
        try {
            ...
            $stmt_exp->execute();
            $expense_id = $stmt_exp->insert_id;
            $stmt_exp->close();

            // Post journal entries: Debit expense category, Credit cash/bank
            post_expense_journal($conn, $expense_id, $category, $amount, $payment_method, $note);
