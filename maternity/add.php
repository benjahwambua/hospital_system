...
?>
<style>
.maternity-workspace{padding:28px 24px 40px;background:#f5f7fb;min-height:calc(100vh - 60px)}
.main-body{padding:0;background:#f5f7fb;min-height:calc(100vh - 60px)}.container-fixed{max-width:1180px;margin:0 auto}
.v-section{background:#fff;border:1px solid #e7ebf2;border-radius:14px;margin-bottom:18px;box-shadow:0 3px 14px rgba(31,45,61,.05);overflow:hidden}.v-header{background:#fff;color:#25324a;padding:16px 20px;font-weight:700;border-bottom:1px solid #edf0f5;font-size:14px}.v-body{padding:20px}
.grid-4{display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin-bottom:14px}.grid-2{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-bottom:14px}
label{font-size:11px;font-weight:700;color:#667085;display:block;margin-bottom:6px;text-transform:uppercase;letter-spacing:.3px}.form-control{width:100%;padding:10px 12px;border:1px solid #d8dee8;border-radius:8px;font-size:14px;background:#fff;color:#344054}.form-control:focus{border-color:#4c84ff;box-shadow:0 0 0 3px rgba(76,132,255,.1);outline:0}
.summary-box{background:#f0fdf4;border:1px solid #bbf7d0;color:#166534;padding:15px;border-radius:10px;margin-bottom:18px}.billing-row{background:#fbfcfe;padding:14px;border-radius:10px;border:1px solid #e7ebf2;position:relative;margin-bottom:10px}
.action-footer{display:flex;gap:10px;margin-top:18px;justify-content:flex-end}.btn-small{border:none;padding:10px 18px;border-radius:8px;font-weight:700;font-size:13px;cursor:pointer}.btn-finalize{background:#198754;color:#fff}.btn-save-only{background:#2f6fed;color:#fff}.btn-add{background:#eef4ff;color:#2f6fed;border:1px solid #d9e5ff;padding:7px 11px;font-size:11px;margin-bottom:10px;border-radius:7px;font-weight:700;cursor:pointer}.btn-remove{background:#fff0f0;color:#c92a2a;border:1px solid #ffd4d4;padding:2px 8px;border-radius:5px;cursor:pointer;position:absolute;top:6px;right:6px;font-size:10px}
.search-area{background:#fff;padding:18px;border-radius:12px;border:1px solid #e7ebf2;margin-bottom:18px;box-shadow:0 3px 12px rgba(31,45,61,.045)}.apt-section{background:#f0f7ff;border:1px solid #cfe1ff;padding:14px;border-radius:9px;margin-top:14px}.ref-section{background:#fff9f2;border:1px solid #ffe2bf;padding:14px;border-radius:9px;margin-top:14px;border-left:4px solid #f59f00}.print-tools{display:flex;gap:8px;justify-content:flex-end;margin-bottom:12px}.btn-print{background:#344054;color:#fff;border:none;padding:8px 12px;border-radius:7px;cursor:pointer;text-decoration:none;display:inline-block}.btn-print:hover{color:#fff;text-decoration:none;background:#25324a}
@media(max-width:900px){.grid-4{grid-template-columns:1fr 1fr}.grid-2{grid-template-columns:1fr}}@media(max-width:560px){.main-body{padding:0 10px}.grid-4{grid-template-columns:1fr}.v-body{padding:15px}.action-footer{flex-direction:column}.btn-small{width:100%}}
