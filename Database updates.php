...
CHANGE COLUMN contact_name contact_person VARCHAR(100);

ALTER TABLE purchase_orders 
ADD COLUMN supplier_id INT NOT NULL AFTER id;

ALTER TABLE purchase_orders 
ADD COLUMN user_id INT NOT NULL AFTER supplier_id;
...
ALTER TABLE purchase_orders 
ADD COLUMN total_amount DECIMAL(10,2) NOT NULL AFTER order_date;

ALTER TABLE purchase_order_items 
CHANGE COLUMN IF EXISTS order_id po_id INT(11),
ADD COLUMN IF NOT EXISTS po_id INT(11) AFTER id;