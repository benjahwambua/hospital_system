...
<div class="hms-form-page"><div class="hms-form-shell"><div class="hms-form-hero"><div><div class="hms-form-kicker">Laboratory · Inventory</div><h1>Add Laboratory Stock Item</h1><p>Record a new laboratory consumable and its opening stock details.</p></div></div>Add Laboratory Stock Item</h2><?php if($success):?><div class="alert alert-success"><?=htmlspecialchars($success)?></div><?php endif;?><?php if($error):?><div class="alert alert-danger"><?=htmlspecialchars($error)?></div><?php endif;?>
